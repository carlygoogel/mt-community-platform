...
const MTCommunityApp = () => {
  ...
  const [users, setUsers] = useState([
    {
      ...
      status: 'available',
      bio: 'Love coffee chats and discussing startups!'
    },
    {
      id: 2,
      name: 'James Liu',
      ...
      status: 'available',
      bio: 'Always down for study sessions'
    },
    {
      id: 3,
      name: 'Maya Patel',
  ...
  const [events, setEvents] = useState([
    ...
    },
    {
      ...
      isPublic: true,
      attendees: 8,
      description: 'Monthly dinner to connect across years'
    }
  ]);
